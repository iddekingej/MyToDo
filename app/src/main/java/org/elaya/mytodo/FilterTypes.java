...
final class FilterTypes {
    ...
    static String[] getFilterTypes(Context pContext){
    ...
    {
        ArrayAdapter<String> lBuildInFilterAdapter=new ArrayAdapter<String>(pContext,R.layout.support_simple_spinner_dropdown_item,FilterTypes.getFilterTypes(pContext));
